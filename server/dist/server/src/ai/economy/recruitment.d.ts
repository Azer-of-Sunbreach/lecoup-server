...
import { InsurrectionAlert } from '../../../../shared/services/ai/economy';
 ...
 */
export declare function handleRecruitment(faction: FactionId, locations: Location[], armies: Army[], roads: Road[], budget: AIBudget, profile: FactionPersonality, turn: number, currentGold: number, insurrectionAlerts?: InsurrectionAlert[], characters?: Character[]): {
 ...
 */
export declare function handleRecruitmentLegacy(faction: FactionId, locations: Location[], armies: Army[], budget: AIBudget, profile: FactionPersonality, turn: number, currentGold: number): number;
