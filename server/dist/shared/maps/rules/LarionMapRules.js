...
exports.LarionMapRules = void 0;
const BaseMapRules_1 = require("./BaseMapRules");
const types_1 = require("../../types");
const characters_1 = require("../../data/characters");
const data_1 = require("../../data");
class LarionMapRules extends BaseMapRules_1.BaseMapRules {
    getInitialCharacters() {
        return characters_1.CHARACTERS_NEW;
    }
    calculateEconomy(state, locations, armies, characters, roads) {
        ...
        let tempLocs = locations.map(loc => {
            if (loc.type === types_1.LocationType.RURAL) {
                ...
                let bonus = loc.isCoastal ? data_1.BONUS_FISHING_HUNTING : data_1.BONUS_HUNTING_ONLY;
...
exports.LarionMapRules = LarionMapRules;
