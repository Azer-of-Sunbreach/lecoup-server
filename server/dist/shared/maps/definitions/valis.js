...
exports.ValisDefinition = void 0;
...
const VALIS_METADATA = {
    [types_1.FactionId.LOYALISTS]: {
        id: types_1.FactionId.LOYALISTS,
        ...
        style: VALIS_FACTION_STYLE[types_1.FactionId.LOYALISTS]
    },
    [types_1.FactionId.PRINCELY_ARMY]: {
        id: types_1.FactionId.PRINCELY_ARMY,
        ...
        style: VALIS_FACTION_STYLE[types_1.FactionId.PRINCELY_ARMY]
    },
    [types_1.FactionId.CONFEDERATE_CITIES]: {
        id: types_1.FactionId.CONFEDERATE_CITIES,
        ...
        style: VALIS_FACTION_STYLE[types_1.FactionId.CONFEDERATE_CITIES]
    },
    [types_1.FactionId.NEUTRAL]: {
        ...
        style: VALIS_FACTION_STYLE[types_1.FactionId.NEUTRAL]
    }
};
const ValisMapRules_1 = require("../rules/ValisMapRules");
exports.ValisDefinition = {
    id: 'valis',
    nameKey: 'maps.valis',
    loreKey: 'common:factionSelect.valisLore',
    factions: [types_1.FactionId.LOYALISTS, types_1.FactionId.PRINCELY_ARMY, types_1.FactionId.CONFEDERATE_CITIES],
    factionMetadata: VALIS_METADATA,
    rules: new ValisMapRules_1.ValisMapRules(),
    uiConfig: {
