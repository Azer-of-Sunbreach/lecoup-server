...
exports.shouldDisableStealFromGranaries = shouldDisableStealFromGranaries;
exports.processStealFromGranaries = processStealFromGranaries;
const types_1 = require("../../../types");
/**
 * Check if the action should be disabled (e.g. no budget)
 */
function shouldDisableStealFromGranaries(leaderBudget) {
    return leaderBudget <= 0;
}
/**
 * Process the Steal From Granaries action
 */
function processStealFromGranaries(leader, location, locations, turn) {
    ...
    const successLog = {
        ...
        type: types_1.LogType.FAMINE, // Or ECONOMY? Using FAMINE/ECONOMY as it relates to food.
    ...
    if (Math.random() < 0.5) {
        warningLog = {
            ...
            type: types_1.LogType.FAMINE, // Fits "Granaries"
