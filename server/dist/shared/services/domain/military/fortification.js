...
exports.executeFortify = void 0;
const data_1 = require("../../../data");
/**
 * Execute fortification construction
 */
const executeFortify = (state, type, id, faction, stageIndex) => {
    let currentLevel = 0;
    ...
    const eligibleArmies = state.armies.filter(a => a.faction === faction &&
        !a.isSpent &&
        !a.isInsurgent &&
        !a.isSieging &&
        !a.action &&
    ...
    if (remainderArmy)
        finalArmies.push(remainderArmy);
