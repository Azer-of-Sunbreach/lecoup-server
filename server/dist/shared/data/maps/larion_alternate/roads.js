...
exports.NEW_ROADS = [
    ...
    { id: 'r_hor_loc', from: 'hornvale_duchy', to: 'hornvale', quality: types_1.RoadQuality.LOCAL, travelTurns: 0, stages: [] },
    // Regional routes - matching original IDs
    {
        id: 'r_sun_ord', from: 'sunbreach_lands', to: 'order_lands', quality: types_1.RoadQuality.GOOD, travelTurns: 3, stages: [
    ...
    {
        id: 'r_ord_hor', from: 'order_lands', to: 'hornvale_duchy', quality: types_1.RoadQuality.GOOD, travelTurns: 2, stages: [
    ...
    {
        id: 'r_hor_gul', from: 'hornvale_duchy', to: 'gullwing_duchy', quality: types_1.RoadQuality.MEDIOCRE, travelTurns: 4, stages: [
    ...
    {
        id: 'r_sun_gre', from: 'sunbreach_lands', to: 'great_plains', quality: types_1.RoadQuality.MEDIOCRE, travelTurns: 3, stages: [
    ...
    {
        id: 'r_gre_tha', from: 'great_plains', to: 'thane_duchy', quality: types_1.RoadQuality.MEDIOCRE, travelTurns: 3, stages: [
    ...
    {
        id: 'r_tha_esm', from: 'thane_duchy', to: 'esmarch_duchy', quality: types_1.RoadQuality.BAD, travelTurns: 3, stages: [
    ...
    {
        id: 'r_esm_nor', from: 'esmarch_duchy', to: 'northern_barony', quality: types_1.RoadQuality.MEDIOCRE, travelTurns: 2, stages: [
    ...
    {
        id: 'r_nor_gre', from: 'northern_barony', to: 'great_plains', quality: types_1.RoadQuality.MEDIOCRE, travelTurns: 3, stages: [
    ...
    {
        id: 'r_gul_tha', from: 'gullwing_duchy', to: 'thane_duchy', quality: types_1.RoadQuality.BAD, travelTurns: 4, stages: [
    ...
    {
        id: 'r_iol_nor', from: 'larion_islands', to: 'northern_barony', quality: types_1.RoadQuality.BAD, travelTurns: 2, stages: [
    ...
    {
        id: 'r_sun_sal', from: 'sunbreach_lands', to: 'saltcraw_viscounty', quality: types_1.RoadQuality.BAD, travelTurns: 2, stages: [
    ...
    {
        id: 'r_ord_sal', from: 'order_lands', to: 'saltcraw_viscounty', quality: types_1.RoadQuality.BAD, travelTurns: 2, stages: [
    ...
    { id: 'r_cat_loc', from: 'cathair', to: 'fairemere_viscounty', quality: types_1.RoadQuality.LOCAL, travelTurns: 0, stages: [] },
    {
        id: 'fairemere_viscounty_gullwing_duchy_road', from: 'fairemere_viscounty', to: 'gullwing_duchy', quality: types_1.RoadQuality.BAD, travelTurns: 2, stages: [
