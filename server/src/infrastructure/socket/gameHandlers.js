...
const battlePhaseUtils_1 = require("./battlePhaseUtils");
function registerGameHandlers(io, socket, gameRoomManager) {
    socket.on('player_action', ({ action }) => {
        try {
            ...
            if (combat) {
                const playerIsInvolvedInCombat = socket.id === combat.attackerSocketId ||
            ...
            if (result.newState.combatState) {
                ...
                if (attackerIsHuman || defenderIsHuman) {
                    ...
                    (0, battlePhaseUtils_1.emitCombatPhaseStarted)(io, code, combat, room.gameState.combatQueue || [], room.gameState);
                }
                if (!attackerIsHuman && !defenderIsHuman) {
            ...
            const clientState = (0, gameLogic_1.getClientState)(room.gameState);
    ...
    socket.on('end_turn', async () => {
        ...
        try {
            ...
            let result = await (0, gameLogic_1.advanceTurn)(room.gameState);
            // Update room state
            room.gameState = result.newState;
            ...
            if (room.gameState.combatState) {
                ...
                if (hasHumanInvolved) {
                    ...
                    (0, battlePhaseUtils_1.emitCombatPhaseStarted)(io, code, room.gameState.combatState, room.gameState.combatQueue || [], room.gameState);
                }
            }
            ...
            const clientStateAfterTurn = (0, gameLogic_1.getClientState)(room.gameState);
            ...
            if (pendingCombatRequest) {
                ...
                if (phaseInfo.active && !room.gameState.combatState && (!room.gameState.combatQueue || room.gameState.combatQueue.length === 0)) {
                    ...
                    (0, battlePhaseUtils_1.emitCombatPhaseEnded)(io, code);
                }
            }
            ...
            while (result.isAITurn) {
                ...
                room.gameState = (0, gameLogic_1.processSingleFactionAITurn)(room.gameState, result.nextFaction);
                ...
                const aiClientState = (0, gameLogic_1.getClientState)(room.gameState);
                ...
                result = await (0, gameLogic_1.advanceTurn)(room.gameState);
                room.gameState = result.newState;
                // Send state update after advancing turn - ALWAYS clear combatState
                const stateAfterAdvance = (0, gameLogic_1.getClientState)(room.gameState);
