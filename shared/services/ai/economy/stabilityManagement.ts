 ...
 * @see shared/services/ai/strategy/insurrectionDefense.ts - Threat detection
 * @module shared/services/ai/economy/stabilityManagement
 */
 ...
 */
export const STABILITY_THRESHOLDS: Record<FactionId, { normal: number; emergency: number }> = {
    ...
    // Valis factions (not typically used in AI, but required for type safety)
    [FactionId.LOYALISTS]: {
        normal: 50,
        emergency: 40
    },
