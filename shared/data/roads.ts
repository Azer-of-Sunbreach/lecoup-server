...
import { Road, RoadQuality, RoadStage, Coordinates } from '../types';
import { INITIAL_LOCATIONS } from './locations';

// Helper to generate stages with explicit background positions
const generateStages = (
    startLoc: { position: Coordinates, backgroundPosition?: Coordinates },
    endLoc: { position: Coordinates, backgroundPosition?: Coordinates },
    stageData: { name: string, flavor: string, defense?: number, backPos?: Coordinates }[]
): RoadStage[] => {
...
const getLoc = (id: string) => INITIAL_LOCATIONS.find(l => l.id === id)!;
...
export const ROADS: Road[] = [
    ...
    { id: 'r_hor_loc', from: 'hornvale_viscounty', to: 'hornvale', quality: RoadQuality.LOCAL, travelTurns: 0, stages: [] },
    ...
    {
        id: 'r_sun_ord', from: 'sunbreach_lands', to: 'order_lands', quality: RoadQuality.GOOD, travelTurns: 3, stages: generateStages(getLoc('sunbreach_lands'), getLoc('order_lands'), [
    ...
    {
        id: 'r_ord_hor', from: 'order_lands', to: 'hornvale_viscounty', quality: RoadQuality.GOOD, travelTurns: 2, stages: generateStages(getLoc('order_lands'), getLoc('hornvale_viscounty'), [
    ...
    {
        id: 'r_hor_gul', from: 'hornvale_viscounty', to: 'gullwing_duchy', quality: RoadQuality.MEDIOCRE, travelTurns: 4, stages: generateStages(getLoc('hornvale_viscounty'), getLoc('gullwing_duchy'), [
    ...
    {
        id: 'r_gul_tha', from: 'gullwing_duchy', to: 'thane_duchy', quality: RoadQuality.BAD, travelTurns: 4, stages: generateStages(getLoc('gullwing_duchy'), getLoc('thane_duchy'), [
    ...
    {
        id: 'r_sun_gre', from: 'sunbreach_lands', to: 'great_plains', quality: RoadQuality.MEDIOCRE, travelTurns: 3, stages: generateStages(getLoc('sunbreach_lands'), getLoc('great_plains'), [
    ...
    {
        id: 'r_gre_tha', from: 'great_plains', to: 'thane_duchy', quality: RoadQuality.MEDIOCRE, travelTurns: 3, stages: generateStages(getLoc('great_plains'), getLoc('thane_duchy'), [
    ...
    {
        id: 'r_tha_esm', from: 'thane_duchy', to: 'esmarch_duchy', quality: RoadQuality.BAD, travelTurns: 3, stages: generateStages(getLoc('thane_duchy'), getLoc('esmarch_duchy'), [
    ...
    {
        id: 'r_esm_nor', from: 'esmarch_duchy', to: 'northern_barony', quality: RoadQuality.MEDIOCRE, travelTurns: 2, stages: generateStages(getLoc('esmarch_duchy'), getLoc('northern_barony'), [
    ...
    {
        id: 'r_nor_gre', from: 'northern_barony', to: 'great_plains', quality: RoadQuality.MEDIOCRE, travelTurns: 3, stages: generateStages(getLoc('northern_barony'), getLoc('great_plains'), [
    ...
    {
        id: 'r_iol_nor', from: 'larion_islands', to: 'northern_barony', quality: RoadQuality.BAD, travelTurns: 2, stages: generateStages(getLoc('larion_islands'), getLoc('northern_barony'), [
    ...
    {
        id: 'r_sun_sal', from: 'sunbreach_lands', to: 'saltcraw_viscounty', quality: RoadQuality.BAD, travelTurns: 2, stages: generateStages(getLoc('sunbreach_lands'), getLoc('saltcraw_viscounty'), [
    ...
    {
        id: 'r_ord_sal', from: 'order_lands', to: 'saltcraw_viscounty', quality: RoadQuality.BAD, travelTurns: 2, stages: generateStages(getLoc('order_lands'), getLoc('saltcraw_viscounty'), [
